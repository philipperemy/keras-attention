...
We apply a `Dense - Softmax` layer with the same number of output parameters as the `Input` layer. The attention matrix has a shape of `input_dims x input_dims` here.
